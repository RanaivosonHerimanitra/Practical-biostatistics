...
In sample, we can calculate a statistic and get its _standard deviation_ which is also called _standard error__. _standard deviation_ reflects the **spread** of the distribution of the statistics we are interested in
