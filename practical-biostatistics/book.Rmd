...
* a null hypothesis (an hypothesis that is more likely to appear ) and
...
The statistical power is the probability of finding true effect when It exists. It directly relates to incertainty during our decision to reject or null the null hypothesis.
